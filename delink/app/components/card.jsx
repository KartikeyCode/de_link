    ...
    return (
        <div className="2xl:w-[30rem] xl:w-[20rem] xl:h-[28rem] 2xl:h-[40rem] rounded-2xl flex flex-col items-center" style={{ backgroundColor: bgcolour, border: `5px solid ${outlinecolour}` }}>
            <div className="flex items-center xl:gap-7 2xl:gap-10">
                ...
                <Image className="w-36 h-40  rounded-tr-xl xl:w-32 xl:h-40 2xl:w-48 2xl:h-60 border-4 border-r-0 border-t-0 rounded-b-xl rounded-r-none border-white" src={pewds} alt="design.png" />
            </div>
            ...
            <Image className=" w-48 rounded-bl-xl 2xl:w-80 xl:w-52 mt-10 border-4 border-l-0 border-b-0 rounded-b-none rounded-r-xl shadow-2xl" src={pewds} alt="NFT" />
